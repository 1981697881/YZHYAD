		...
		<view class="wrapper">
			...
			<view class="login-box y-f">
				<view class="input-item x-c">
					<text class="inp-title">拓展码</text>
					<input class="inp" v-model="expand" type="text" placeholder="请输入拓展码" placeholder-class="pl" />
					<button class="cu-btn code-btn" @tap="getExpandCode">可扫描获取</button>
				</view>
				<view class="input-item x-c">
